...
#define ESP_GOOGLE_SHEET_CLIENT_WIFI_IS_AVAILABLE
...
#define ESP_GOOGLE_SHEET_CLIENT_HAS_WIFI_DISCONNECT
#endif
...
#define ESP_GOOGLE_SHEET_CLIENT_HAS_WIFI_TIME
#endif

#if defined(MB_ARDUINO_PICO) && __has_include(<WiFiMulti.h>)
#define ESP_GOOGLE_SHEET_CLIENT_HAS_WIFIMULTI
#endif
...
#if !defined(ESP_GOOGLE_SHEET_CLIENT_DISABLE_NATIVE_ETHERNET)

#if defined(ESP32) && __has_include(<ETH.h>)
#include <ETH.h>
#define ESP_GOOGLE_SHEET_CLIENT_ETH_IS_AVAILABLE
...
#if defined(ESP_GOOGLE_SHEET_CLIENT_TINYGSM_IS_AVAILABLE) && __has_include(<TinyGsmClient.h>)
#include <TinyGsmClient.h>
#define ESP_GOOGLE_SHEET_CLIENT_GSM_MODEM_IS_AVAILABLE
#endif
